...
const { Sven_Test_Project_ID } = require('./projectIds');
const axios = require('axios');
const PROJECT_ID = Sven_Test_Project_ID;

// Get phases directly by project ID
...
.then(async phaseResponse => {
    ...
    console.log(`Found ${phases.length} phases for project ${PROJECT_ID}`);
...
.catch(phaseError => {
    console.log(`Error fetching phases for project ${PROJECT_ID}:`, phaseError.message);
    return [{
        projectId: PROJECT_ID,
        projectName: `Project ${PROJECT_ID}`,
        phases: null,
